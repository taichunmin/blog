...
description: 在網路上有很多電子名片服務，每月跟使用者收取使用費，於是筆者就想說也做一個類似的給大家免費製作及使用！
...
在網路上很常看到有人把「Flex 訊息模擬器」的「多頁訊息」範例做成電子名片，然後跟使用者每月收取使用費，於是筆者就想說也做一個類似的給大家免費製作及使用，這名片在手機版和電腦版都能正常顯示喔！
...
::: tip 產生 Google 地圖跨平台網址
* [筆者寫的小工具](https://taichunmin.idv.tw/pug/google-maps-urls.html)
:::
